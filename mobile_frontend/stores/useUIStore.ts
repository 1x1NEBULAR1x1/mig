...
type Values = {
  ...
  isSubCategoriesSiderOpened: boolean
  isCartOpened: boolean
  isHistoryListOpened: boolean
}
...
type Actions = {
  ...
  setIsHeaderMenuOpened: (isHeaderMenuOpened: boolean) => void
  setIsSubCategoriesSiderOpened: (isSubCategoriesSiderOpened: boolean) => void
  setIsCartOpened: (isCatrOpened: boolean) => void
  setIsHistoryListOpened: (isHistoryListOpened: boolean) => void
}
...
export const useUIStore = create<Values & Actions>((set) => ({
  ...
  isSubCategoriesSiderOpened: false,
  isCartOpened: false,
  isHistoryListOpened: true,
  setIsHistoryListOpened: (isHistoryListOpened) => set(() => ({ isHistoryListOpened: isHistoryListOpened })),
  setIsCartOpened: (isCatrOpened) => set(() => ({ isCartOpened: isCatrOpened })),
  setIsSubCategoriesSiderOpened: (isSubCategoriesSiderOpened) => set(() => ({ isSubCategoriesSiderOpened: isSubCategoriesSiderOpened })),
  setIsHeaderMenuOpened: (isHeaderMenuOpened) => set(() => ({ isHeaderMenuOpened: isHeaderMenuOpened, isProfileOpened: false })),
  ...
  setViewOrderHistory: (order) => set(() => ({ viewOrderHistory: order, isHistoryListOpened: false })),
  ...
  setIsProfileOpened: (isProfileOpened) => set(() => ({ isProfileOpened: isProfileOpened, isHeaderMenuOpened: false })),
