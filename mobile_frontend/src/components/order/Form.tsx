        ...
        <div className={styles.formBodySeparator}>
          <div className={styles.formElementContainer}>
            ...
            <div className={styles.formInputElement}>
              ...
              />
              {error === 'street' && <p className={styles.formInputElementErrer}>*данное поле обязательно</p>}
            </div>
            <div className={styles.formInputElements}>
              <div className={styles.formInputElement}>
                ...
                />
                {error === 'house' && <p className={styles.formInputElementErrer}>*данное поле обязательно</p>}
              </div>
              <div className={styles.formInputElement}>
                ...
                />
                {error === 'flat' && <p className={styles.formInputElementErrer}>*данное поле обязательно</p>}
              </div>
              <div className={styles.formInputElement}>
