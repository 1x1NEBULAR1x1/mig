...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174", "http://localhost:5175", 'http://localhost', 'http://127.0.0.1'],
...
app.mount(path='/assets', app=StaticFiles(directory="./mobile_frontend/dist/assets"), name="assets")
app.mount(path='/admin', app=StaticFiles(directory="./admin_panel/dist/assets"), name="admin")
app.mount(path='/static', app=StaticFiles(directory="static"), name="static")
app.mount(path='/panel/static', app=StaticFiles(directory="static"), name="panel/static")
