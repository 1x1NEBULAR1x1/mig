          ...
          <div className={styles.productAddButtonContainer}>
            <div className={styles.productAddButtons}>
              <div className={styles.productAddButton} onClick={() => {
                ...
                <svg width="0.72916667vw" height="0.166667vh" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <svg width="0.78125vw" height="1.33333vh" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
