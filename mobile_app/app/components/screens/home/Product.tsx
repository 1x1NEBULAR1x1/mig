...
const Product = ({product, className} : {product: ProductType, className?: string}) => {
  ...
  return (
    <TouchableOpacity
      className={className + ' w-[48%] aspect-[8/17] mr-[3.5%] bg-white p-4 rounded-3xl flex-col gap-1 justify-evenly'}
